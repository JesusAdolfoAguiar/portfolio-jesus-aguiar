...
This is a portfolio website built using React, Tailwind CSS, and TypeScript. The website showcases my skills and projects as a Shopify - Frontend developer. For the contactform I used a backend, which is build on node.js and express.
